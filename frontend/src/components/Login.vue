<template>
  <v-container class="container">
    <v-row class="fill-height">
        <v-col cols="12" md="6" class="d-flex align-center justify-center">
          <v-card-text class="mt-12">
            ...
            <h6 class="text-center grey--text">
              Faça login na sua conta para continuar construindo
              <br />e editando seus fluxos de integração
            </h6>
            <v-row align="center" justify="center">
              <v-col cols="12" sm="8">
                ...
                <v-row>
                  <v-col cols="12" sm="7">
                    <v-checkbox label="Lembrar-me" class="mt-n1" color="blue">
                    </v-checkbox>
                  </v-col>
                  <v-col cols="12" sm="5">
        ...
        <v-col cols="12" md="6" class="blue d-flex align-center justify-center">
          <div style="text-align: center">
            <v-card-text class="white--text">
              <h3 class="text-center">Ainda não tem uma conta?</h3>
              <h6 class="text-center">
                Vamos configurar tudo para que você possa começar a criar sua
                primeira<br />
